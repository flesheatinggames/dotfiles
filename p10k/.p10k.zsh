# Generated by Powerlevel10k configuration wizard on 2025-02-10 at 11:21 EST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 4117.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, angled separators, blurred heads, round tails, 2 lines, dotted, left frame,
# dark-ornaments, compact, many icons, concise, instant_prompt=verbose.
